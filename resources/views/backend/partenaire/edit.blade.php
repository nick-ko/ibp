        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Partenaires</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Ajouter un partenaire</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <form class="form-horizontal row-fluid" method="post" action="{{route('partenaire.update')}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <input type="text" class="form-control" name="link" value="{{$partenaire->link}}">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="control-group">
